...
local TabCombat = Window:Tab({ Title = "Auto Farm", Icon = "icon" })
local TabESP = Window:Tab({ Title = "ESP", Icon = "icon" })
local TabHighlight = Window:Tab({ Title = "Highlight ESP", Icon = "icon" })
local TabAim = Window:Tab({ Title = "Aim Assist", Icon = "icon" })
local TabPlayerAim = Window:Tab({ Title = "Player Aim", Icon = "icon" })
local TabProt = Window:Tab({ Title = "Protection", Icon = "icon" })
local TabPlayers = Window:Tab({ Title = "Players", Icon = "icon" })
local TabWaypoints = Window:Tab({ Title = "Waypoints", Icon = "icon" })
local TabVisuals = Window:Tab({ Title = "Visuals", Icon = "icon" })
local TabWorld = Window:Tab({ Title = "World", Icon = "icon" })
local TabFPS = Window:Tab({ Title = "FPS/Stats", Icon = "icon" })
local TabConfig = Window:Tab({ Title = "Config", Icon = "icon" })
local TabUtil = Window:Tab({ Title = "Utility", Icon = "icon" })
...
local PlayerAimStatus = TabPlayerAim:Label({ Title = "Status: Aguardando..." })
...
local statsLabel = TabFPS:Label({ Title = "Carregando..." })
local fpsLabel = TabFPS:Label({ Title = "FPS: 0" })
local pingLabel = TabFPS:Label({ Title = "Ping: 0ms" })
local playersLabel = TabFPS:Label({ Title = "Players: 0" })
