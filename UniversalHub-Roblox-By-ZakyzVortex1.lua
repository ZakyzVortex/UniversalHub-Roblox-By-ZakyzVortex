...
local AIM_TEAM_FILTER = "EnemyTeam"  -- All, MyTeam, EnemyTeam
...
TabAim:CreateToggle({
    ...
    Callback = function(v)
        ...
        if v then
            local filterText = AIM_TEAM_FILTER == "All" and "todos os jogadores" 
                or AIM_TEAM_FILTER == "MyTeam" and "apenas seu time" 
                or "apenas inimigos"
            Rayfield:Notify({
